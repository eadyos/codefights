/*
https://codefights.com/arcade/code-arcade/time-river/4JypHBf7kQc3GjhRF


John Doe likes holidays very much, and he was very happy to hear that his country's government decided to 
introduce yet another one. He heard that the new holiday will be celebrated each year on the xth week of month, on weekDay.
...
The new holiday will be celebrated every November on the 3rd Wednesday of the month. In 2016 the 3rd Wednesday falls 
...
int holiday(int x, String weekDay, String month, int year) {

    def d = Date.parse("MMMM-yyyy", "$month-$year")
    while(d.format("EEEE") != weekDay){
        d+=1
    }
    d+= 7 * (x-1)
    d.format("MMMM") == month ? d[Calendar.DAY_OF_MONTH] : -1
