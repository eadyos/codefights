/*
https://codefights.com/arcade/code-arcade/waterfall-of-integration/tQgasP8b62JBeirMS


Sudoku is a number-placement puzzle. The objective is to fill a 9 × 9 grid with digits so that each column, each row, and 
