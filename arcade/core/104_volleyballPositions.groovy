/*
https://codefights.com/arcade/code-arcade/list-backwoods/fmYdsYcGfaTu4yTQt
...
def volleyballPositions(formation, k) {
    ...
    def positions = [
        [1,0], [0,1], [1,2], [3,2], [2,1], [3,0]
    ]
    def players = positions.collect{
        formation[it[0]][it[1]]
    }
    (0..5).each{
        def p = positions[it]
        formation[p[0]][p[1]] = players[(it+k) % 6] 
    }
    formation
